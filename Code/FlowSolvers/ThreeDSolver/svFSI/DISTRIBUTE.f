...
!     This routine distributes equations between processors
      ...
      CALL cm%bcast(lEq%ls%RI%relTol)
      CALL cm%bcast(lEq%ls%GM%relTol)
      CALL cm%bcast(lEq%ls%CG%relTol)
      CALL cm%bcast(lEq%ls%RI%absTol)
      CALL cm%bcast(lEq%ls%GM%absTol)
      CALL cm%bcast(lEq%ls%CG%absTol)
      CALL cm%bcast(lEq%ls%LS_type)
      CALL cm%bcast(lEq%ls%RI%mItr)
      CALL cm%bcast(lEq%ls%GM%mItr)
      CALL cm%bcast(lEq%ls%CG%mItr)
      CALL cm%bcast(lEq%ls%RI%sD)
      CALL cm%bcast(lEq%ls%GM%sD)
      CALL cm%bcast(lEq%ls%CG%sD)
      CALL cm%bcast(lEq%ls%foC)
